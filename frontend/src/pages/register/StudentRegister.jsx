        ...
        <AuthLayout title="Student Registration" subtitle="Join our academic community">
                    ...
                    {steps.map((step) => {
                        ...
                        return (
                            <div key={step.id} className="flex flex-col items-center gap-2">
                                ...
                                <span className={`text-xs font-semibold ${isActive ? 'text-[#B35900]' : 'text-gray-400'}`}>
                                    {step.title}
                                </span>
                            </div>
                        )
            ...
            <div className="text-center mt-6">
                <p className="text-sm text-gray-500">
                    Already have an account? <Link to="/login/student" className="text-indigo-600 font-medium hover:underline">Sign in</Link>
                </p>
            </div>
        </AuthLayout>
    );
